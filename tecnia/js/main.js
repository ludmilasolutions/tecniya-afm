...
async function initApp() {
  ...
  // TecniBot
  const TECNIBOT_ID = '00000000-0000-0000-0000-0000000000a1';
  const openBot = () => {
    import('./chat.js').then(m => m.openChatWith(TECNIBOT_ID));
  };
  on('tecnibot-fab', 'click', openBot);
  on('menu-tecnibot', 'click', e => { e.preventDefault(); hideUserMenu(); openBot(); });
